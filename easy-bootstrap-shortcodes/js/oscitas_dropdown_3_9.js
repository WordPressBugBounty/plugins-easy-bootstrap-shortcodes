(function() {
    var objNew = typeof ebs_dropdown_obj === 'string' ? jQuery.parseJSON( ebs_dropdown_obj ) : ebs_dropdown_obj;
        ...
        if(typeof val=='object'){
            ...
            var n={text:val['name'],image:ebs_url+'/shortcode/'+ind+'/icon.png',icon:'osc_icon '+ind, onclick : function() {
                ...
                if(ind =="btngrptool"){
                    ...
                    ebsInsertShortcode('[btngrptoolbar class="yourcustomclass"][/btngrptoolbar]');
                }
                //else if(ind == "toggles"){
    ...
    var objGrp = typeof ebs_dropdown_grp === 'string' ? jQuery.parseJSON( ebs_dropdown_grp ) : ebs_dropdown_grp, grps_obj = [];
